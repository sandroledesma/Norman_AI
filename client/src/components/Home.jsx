...
function Home() {
    return (
        <div className="min-h-screen bg-gray-100 p-10">
            <div className="flex bg-light-green flex-col items-center justify-center text-center shadow-md p-8 mb-12">
            ...
            <div className="bg-light-green p-8 rounded shadow-md mb-12">
